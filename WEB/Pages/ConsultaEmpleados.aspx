<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Main.Master" AutoEventWireup="true" CodeBehind="ConsultaEmpleados.aspx.cs" Inherits="WEB.Pages.ConsultaEmpleados" %>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="ImgDescargar" runat="server" 
                                                        ...
                                                        NavigateUrl='<%# "~/Pages/DetalleHojaDeVida.aspx?Id=" + Eval("UsuarioID") + ""%>'
                                                        ImageUrl="~/Images/Icons/magnifying-glass-2x.png" ToolTip="Ver Datos del Empleado"
                                                        Target="_blank" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    </Columns>
