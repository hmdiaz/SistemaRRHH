 <%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Main.Master" AutoEventWireup="true" CodeBehind="MiHojaDeVida.aspx.cs" Inherits="WEB.Pages.MiHojaDeVida" Culture="es-CO" UICulture="Auto" %>
            ...
            <div class="container-fluid">
                                ...
                                <td colspan="3">
                                    <div class="form-inline">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlTipoIdentificacion" runat="server" Enabled="false" CssClass="form-control col-xs-10">
                                            </asp:DropDownList>
                                        ...
                                        <div class="input-group col-sm-20">
                                            ...
                                            <asp:TextBox ID="txtDocumentoIdentidad" onkeydown = "return (event.keyCode!=13);" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                            <div class="input-group-btn">
                                                <asp:RequiredFieldValidator 
                                                    ID="RequiredFieldValidator2" 
                                                    runat="server" 
                                                    ErrorMessage="(*) El Documento de Identidad es requerido" 
                                                    Text="(*)" 
                                                    ControlToValidate="txtDocumentoIdentidad" >
                                                </asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>                        
                                ...
                                <td colspan="3">
                                    <div class="form-inline">
                                        <div class="input-group col-sm-5">
                                            ...
                                            <asp:TextBox ID="txtPrimerNombre" onkeydown = "return (event.keyCode!=13);" CssClass="form-control uppercase" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                        ...
                                        <div class="input-group col-sm-5">
                                            ...
                                            <asp:TextBox ID="txtSegundoNombre" onkeydown = "return (event.keyCode!=13);" CssClass="form-control uppercase" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </td>                                
                            </tr>
                                ...
                                <td colspan="3">
                                    <div class="form-inline">
                                        <div class="input-group col-sm-5">
                                            ...
                                            <asp:TextBox ID="txtPrimerApellido" onkeydown = "return (event.keyCode!=13);" CssClass="form-control uppercase" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                        ...
                                        <div class="input-group col-sm-5">
                                            ...
                                            <asp:TextBox ID="txtSegundoApellido" onkeydown = "return (event.keyCode!=13);" CssClass="form-control uppercase" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td colspan="4">
                                    <div class="form-inline">
                                        <div class="input-group col-sm-4">
                                            ...
                                            <asp:TextBox ID="txtFechaNacimiento" onkeydown = "return (event.keyCode!=13);" CssClass="form-control col-sm-3" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                                <asp:Image ID="iBtnFechaNacimiento" runat="server" ImageUrl="~/Images/calendar32.png" />
                                                <asp:RequiredFieldValidator 
                                ...
                                <td colspan="4">
                                    <div class="form-inline">
                                        <div class="input-group col-sm-8">
                                            ...
                                            <asp:TextBox ID="txtDireccion" onkeydown = "return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                        ...
                                        <div class="input-group col-sm-3">
                                            ...
                                            <asp:TextBox ID="txtBarrio" onkeydown = "return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                ...
                                <td colspan="4">
                                    <div class="form-inline">
                                        <div class="input-group col-sm-3">
                                            ...
                                            <asp:TextBox ID="txtTelefonoFijo" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3" runat="server"></asp:TextBox>
                                        ...
                                        <div class="input-group col-sm-3">
                                            ...
                                            <asp:TextBox ID="txtCelular" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                                <asp:RequiredFieldValidator 
                                        ...
                                        <div class="input-group col-sm-5">
                                            ...
                                            <asp:TextBox ID="txtCorreoPersonal" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div class="input-group col-sm-3">
                                                    ...
                                                    <asp:DropDownList ID="ddlArea" Enabled="false" runat="server" CssClass="form-control col-xs-10" AutoPostBack="true" 
                                                ...
                                                <div class="input-group col-sm-4">
                                                    ...
                                                    <asp:DropDownList ID="ddlCargo" Enabled="false" runat="server" CssClass="form-control col-xs-10">
                                                    </asp:DropDownList>
                                                </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                ...
                                <td colspan="4">
                                    <div class="form-inline">
                                        <div class="input-group col-sm-4">
                                            ...
                                            <asp:TextBox ID="txtCelularCorporativo" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3" runat="server"></asp:TextBox>
                                            <%--<div class="input-group-btn">
                                        ...
                                        <div class="input-group col-sm-7">
                                            ...
                                            <asp:TextBox ID="txtCorreoCorporativo" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                            <div class="input-group-btn">
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        <div class="input-group col-sm-5">                                                        
                                                            ...
                                                            <asp:TextBox ID="txtNombresIntegrante" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                                            <div class="input-group-btn">
                                                                <asp:RequiredFieldValidator 
                                                        ...
                                                        <div class="input-group col-sm-5">
                                                            ...
                                                            <asp:TextBox ID="txtApellidosIntegrante" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                                            <div class="input-group-btn">
                                                                <asp:RequiredFieldValidator 
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        ...
                                                        <div class="input-group col-sm-5">
                                                            ...
                                                            <asp:TextBox ID="txtFechaNacimientoIntegrante" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-5" runat="server"></asp:TextBox>
                                                            <%--<asp:HiddenField ID="txtFechaActual" runat="server" Value="<%# DateTime.Today.ToShortDateString() %>" />--%>
                                                            <div class="input-group-btn">
                                                                ...
                                                                <asp:CompareValidator 
                                                                        Id="CompararFechaMayor" 
                                                                        runat="server" 
                                                                        Cultureinvariantvalues="true" 
                                                                        Display="Dynamic" 
                                                                        EnableClientScript="true"  
                                                                        ControlToValidate="txtFechaNacimientoIntegrante" 
                                                                        ErrorMessage="(*) La Fecha de Nacimiento no debe ser mayor a la fecha actual" 
                                                                        Type="Date" 
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        <div class="input-group col-sm-6">
                                                            ...
                                                            <asp:TextBox ID="txtOcupacionIntegrante" onkeydown = "return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                        ...
                                                        <asp:GridView EmptyDataText="No se ha agregado ninguna Información Académica" 
                                                            ...
                                                            <EmptyDataRowStyle Font-Bold="True" Font-Italic="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                <Columns>
                                                                        ...
                                                                        SortExpression="DateField" />
                                                                        <asp:BoundField DataField="TituloObtenido" HeaderText="Título Obtenido" 
                                                                        SortExpression="DateField" />
                                                                        <asp:BoundField DataField="NombreNivelFormacion" HeaderText="Nivel Formación" 
                                                                        SortExpression="DateField" />
                                                                        ...
                                                                        SortExpression="DateField" />
                                                                        <asp:BoundField DataField="FechaFinalizacion" DataFormatString="{0:d}" HeaderText="Fecha de Finalización" 
                                                                        SortExpression="DateField" />
                                                                        <asp:TemplateField HeaderText="">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton 
                                                        ...
                                                        <td>
                                                            <div class="form-inline">
                                                                <div class="input-group col-sm-6">
                                                                    ...
                                                                    <asp:TextBox ID="txtInstitucion" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                                                    <div class="input-group-btn">
                                                                        <asp:RequiredFieldValidator 
                                                                ...
                                                                <div class="input-group col-sm-5">
                                                                    ...
                                                                    <asp:TextBox ID="txtTituloObtenido" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                                                    <div class="input-group-btn">
                                                                        <asp:RequiredFieldValidator 
                                                        ...
                                                        <td>
                                                            <div class="form-inline">
                                                                ...
                                                                <div class="input-group col-sm-3">                                                                
                                                                    ...
                                                                    <asp:TextBox ID="txtFechaInicioEstudio" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-5" runat="server"></asp:TextBox>
                                                                    <div class="input-group-btn">
                                                                        ...
                                                                        <asp:CompareValidator 
                                                                            ...
                                                                            runat="server" 
                                                                            ErrorMessage="(*) La Fecha de Inicio del Estudio debe tener un formato de fecha correcto"
                                                                            ControlToValidate="txtFechaInicioEstudio"
                                                                            Operator="DataTypeCheck" 
                                                                ...
                                                                <div class="input-group col-sm-3">
                                                                    ...
                                                                    <asp:TextBox ID="txtFechaFinalizacionEstudio" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-5" runat="server"></asp:TextBox>                                                                
                                                                    <div class="input-group-btn">
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <div class="input-group col-sm-6">
                                                    ...
                                                    <asp:TextBox ID="txtEmpresa" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                                    <div class="input-group-btn">
                                                        <asp:RequiredFieldValidator 
                                                ...
                                                <div class="input-group col-sm-5">
                                                    ...
                                                    <asp:TextBox ID="txtCargo" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-3 uppercase" runat="server"></asp:TextBox>
                                                    <div class="input-group-btn">
                                                        <asp:RequiredFieldValidator 
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <div class="input-group col-sm-4">                                                                
                                                    ...
                                                    <asp:TextBox ID="txtFechaIngreso" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-5" runat="server"></asp:TextBox>
                                                    <div class="input-group-btn">
                                                ...
                                                <div class="input-group col-sm-4">
                                                    ...
                                                    <asp:TextBox ID="txtFechaRetiro" onkeydown="return (event.keyCode!=13);" CssClass="form-control col-sm-5" runat="server"></asp:TextBox>                                                                
                                                    <div class="input-group-btn">
                                                        ...
                                                        <%--<asp:CompareValidator 
                                                                Id="CompararFechaRetiroExpLaboral" 
                                                                runat="server" 
                                                                Cultureinvariantvalues="true" 
                                                                Display="Dynamic" 
                                                                EnableClientScript="true" 
                                                                ControlToValidate="txtFechaRetiro" 
                                                                ErrorMessage="(*) La Fecha de Retiro no debe ser mayor a la fecha actual" 
                                                                Type="Date" 
                                                                SetFocusOnError="true" 
                                                                Operator="LessThanEqual" 
                                                                Text="*"
                                                        ...
                                                        <div class="input-group col-sm-4">
                                                            ...
                                                            <div class="input-group-btn">
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" 
                                                                    ErrorMessage="(*) El Municipio es requerido" Text="(*)" 
              ...
              <asp:Panel ID="Panel7" runat="server">
                  <asp:UpdateProgress ID="UpdateProgress7" DisplayAfter="10" 
                    runat="server" AssociatedUpdatePanelID="UpdatePanel1">
                        <ProgressTemplate>
                          <div class="divWaiting">	                        
	                        <asp:Image ID="imgWaitCombos" 
                                       runat="server" 
	                                   ImageAlign="AbsMiddle" 
                                       ImageUrl="~/Images/Loaders/image_717505.gif" />
                                       <br />
                            <asp:Label ID="lblWaitCombos" 
                                       runat="server" 
              ...
              <asp:Panel ID="Panel8" runat="server">
                  <asp:UpdateProgress ID="UpdateProgress8" DisplayAfter="10" 
                    runat="server" AssociatedUpdatePanelID="UpdatePanel6">
                        <ProgressTemplate>
                          <div class="divWaiting">	                        
	                        <asp:Image ID="imgWaitCombosEstudio" 
                                       runat="server" 
	                                   ImageAlign="AbsMiddle" 
                                       ImageUrl="~/Images/Loaders/image_717505.gif" />
                                       <br />
                            <asp:Label ID="lblWaitCombosEstudio" 
                                       runat="server" 
	                                   Text=" Por favor espere la solicitud se está procesando... " />
                          </div>
                        </ProgressTemplate>
              ...
              <asp:Panel ID="Panel9" runat="server">
                  <asp:UpdateProgress ID="UpdateProgress9" DisplayAfter="10" 
                    runat="server" AssociatedUpdatePanelID="UpdatePanel3">
                        <ProgressTemplate>
                          <div class="divWaiting">	                        
	                        <asp:Image ID="imgWaitCombosExp" 
                                       runat="server" 
	                                   ImageAlign="AbsMiddle" 
                                       ImageUrl="~/Images/Loaders/image_717505.gif" />
                                       <br />
                            <asp:Label ID="lblWaitCombosExp" 
                                       runat="server" 
	                                   Text=" Por favor espere la solicitud se está procesando... " />
                          </div>
                        </ProgressTemplate>
              ...
              <script type="text/javascript">
                  $(document).ready(function () {
                      $("#ContentPlaceHolder1_btnAdicionarIntegrante").on("click", function () {
                          ...
                          $("#ContentPlaceHolder1_ddlParentesco").val("0");
                      })
                      ...
                      $("#ContentPlaceHolder1_btnAdicionarEstudio").on("click", function () {
                          ...
                          $("#ContentPlaceHolder1_ddlNivelFormacion").val("0");
                      })
                      ...
                      $("#ContentPlaceHolder1_btnAdicionarExperienciaLaboral").on("click", function () {
                          ...
                          $("#ContentPlaceHolder1_ddlSector").val("0");
                          $("#ContentPlaceHolder1_ddlAreaTrabajo").val("0");
                      })
                  });
            </script>
 </asp:Content>
